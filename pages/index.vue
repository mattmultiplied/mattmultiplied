<template>
  <div>
    <Hook title="Helping brands figure out how to stay relevant in a digital world &#127757;"></Hook>

    <div class="container mx-auto px-4 py-8 md:px-16 md:pb-16 text-indigo-800">
      ...
      <div class="md:w-9/12 mb-24">
        <h2 class="text-4xl font-bold mb-8">&#128104; Technical Tools</h2>
      ...
      <div class="md:w-9/12">
        <h2 class="text-4xl font-bold mb-8">&#128170; Areas of Expertise</h2>
